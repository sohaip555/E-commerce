            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
                ...
                @foreach($brands as $brand)
                    ...
                    <div class="bg-white rounded-lg shadow-md dark:bg-gray-800" wire:key="{{ $brand->id }}">
                        <a href="/products/?brands_selected[0]={{ $brand->id }}">
        ...
        <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
            <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6">
                ...
                @foreach($categories as $category)
                    ...
                    {{-- <a href="{{ route('category.show', $categorie->slug) }}" class=""> --}}
                    <a  class="group flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-md
                        transition dark:bg-slate-900 dark:border-gray-800 dark:focus:outline-none
                        dark:focus:ring-1 dark:focus:ring-gray-600"
                        href="/products/?categories_selected[0]={{ $category->id }}"
